        ...
        <table class="item">
            <tbody>
                ...
                @foreach($orderdetails as $key => $itemrow)
                  <tr>
                    <th class="text-left">{{$key+1}}</td>
                    <th class="text-left">{{ $itemrow["product_name"] ?? '' }}</th>
                    <th class="text-center">{{ $itemrow["qty"] ?? '' }}</th>
                    <!-- <th class="text-right">{{  $itemrow["total_amount"]}}</th> -->
