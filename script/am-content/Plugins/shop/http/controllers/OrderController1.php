...
class OrderController extends controller
{
    ...
    public function show($id)
    {
      ...
      return view('plugin::order.show',compact('info','riders', 'orderdetails'));
    ...
    public function invoice($id)
    {
      ...
      // $pdf->save(storage_path('pdf/order/invoice'.$id.'.pdf'));

      // $pdf->stream('result.pdf');
      // $content = $pdf->download()->getOriginalContent();
      // Storage::put('/pdf/order/'.$id.'/bubla.pdf',$content);
    ...
    public function invoice_print($id)
    {
      ...
      $vendor_info=json_decode($info->vendorinfo->info->content);
      $orderdetails = OrderDetails::where('order_id',$id)->get()->toArray();
     return view('plugin::order.invoice_print',compact('info','customer_info','vendor_info', 'orderdetails'));
