...
Route::group(['as' =>'admin.shop.','prefix'=>'admin/shop','namespace'=>'Amcoders\Plugin\product\http\controllers','middleware'=>'web','auth','admin'],function(){
	...
	Route::post('package/approve','PackageController@approvePackage')->name('approvepackage');
	Route::post('package/bulkaction','PackageController@bulkAction')->name('bulkaction');
