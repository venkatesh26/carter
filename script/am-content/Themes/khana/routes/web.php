...
Route::group(['namespace'=>'Amcoders\Theme\khana\http\controllers','middleware'=>'web'],function(){
	...
	Route::get('/store/{slug}/{packageslug}','StoreController@showpakages')->name('store.showpakages');

	// Route::post('/continuetocartview','CartviewController@continuetocartview')->name('cartview.continuetocartview');
	Route::post('cartview','CartController@cartview')->name('cart.cartview');
	Route::get('cartlist','CartController@cartlist')->name('cart.cartlist');
	Route::post('calculatecart','CartController@calculatecart')->name('cart.calculatecart');
	...
	Route::get('thankyou','Restaurant\RegisterController@thankyou')->name('thankyou');
	Route::get('error','Restaurant\RegisterController@error')->name('error');
	...
	Route::get('order/confirmation/{id}','CheckoutController@confirmation1')->name('order.confirmation1');
	...
	Route::post('restaurant/register/step/2','Restaurant\RegisterController@step_3_payment')->name('restaurant.register_step_2');

	Route::get('restaurant/register/stripe', 'Restaurant\RegisterController@stripe_view');

	Route::post('register-stripe-charge','Restaurant\RegisterController@stripe')->name('register.stripe.charge');
	...
	// Route::post('restaurant/register/step/4','Restaurant\RegisterController@step_4')->name('restaurant.register_step_4');


	Route::get('baker/register','Baker\RegisterController@index')->name('baker.register');
	Route::post('baker/register','Baker\RegisterController@store')->name('baker.register');
	Route::get('baker/register/step/2','Baker\RegisterController@step_2')->name('baker.register_step_2');
	Route::post('baker/register/step/2','Baker\RegisterController@step_2_store')->name('baker.register_step_2');
	Route::get('baker/register/step/3','Baker\RegisterController@step_3')->name('baker.register_step_3');
	Route::post('baker/register/step/3','Baker\RegisterController@step_3_store')->name('baker.register_step_3');

	Route::get('baker/register/step/4','Baker\RegisterController@step_4')->name('baker.register_step_4');
	Route::post('baker/register/step/4','Baker\RegisterController@step_4')->name('baker.register_step_4');
