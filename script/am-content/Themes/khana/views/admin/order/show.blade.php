    ...
    <div class="card-body">
      ...
      <div class="profile-widget">
       ...
       <div class="profile-widget-description">
        ...
        ?>
        @if($info->order_type == 1)
        <div class="profile-widget-name">{{ __(' Delivery Address 1') }}: <div class="text-muted d-inline font-weight-normal">{{ $customerInfo->flatno ?? '' }}<br>{{ $customerInfo->address ?? '' }}</div></div>
        @endif
