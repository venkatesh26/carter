	...
	<div class="store-area store_fixed single-caters">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-12 p-0 mt-40">

					<div class="container single-cater-info">
						<div class="row">
							<div class="col-lg-3 p-0">
								<img src="{{ asset('uploads/register/2022-08-02-62e94b59b1d74.jpg') }}" class="img-fluid single-cater-logo rounded-circle" alt="">
							</div>

							<div class="col-lg-5 p-0 mt-40">
							...
							<div class="col-lg-4 p-0 text-center">
								...
								<div class="row p-0 text-center mt-30">
									<div class="col-lg-6 ">
										<img src="{{ asset('uploads/register/2022-08-02-62e94b59b1d74.jpg') }}" class="rounded img-thumbnail img-fluid" alt="">
									</div>
									<div class="col-lg-6">
							...
							<div class="online-food tab-pane fade in active show" id="menuslist">
								...
								<div class="container">
									<div class="row mt-40 mb-20">
										...
										<div class="col-lg-3 col-md-4 mb-20">
											<div class="single-menu">
												<h4>{{ __('Menu option 3') }}</h4>
											</div>
										</div>

										<div class="col-lg-3 col-md-4 mb-20">
											<div class="single-menu">
												<h4>{{ __('Menu option 4') }}</h4>
											</div>
										</div>

										<div class="col-lg-3 col-md-4 mb-20">
											<div class="single-menu">
												<h4>{{ __('Menu option 5') }}</h4>
											</div>
										</div>

										<div class="col-lg-3 col-md-4 mb-20">
											<div class="single-menu">
												<h4>{{ __('Menu option 6') }}</h4>
											</div>
										</div>

										<div class="col-lg-3 col-md-4 mb-20">
											<div class="single-menu">
												<h4>{{ __('Menu option 7') }}</h4>
											</div>
										</div>

										<div class="col-lg-3 col-md-4 mb-20">
											<div class="single-menu">
												<h4>{{ __('Menu option 8') }}</h4>
											</div>
										</div>
