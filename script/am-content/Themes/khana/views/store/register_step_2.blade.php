						...
						<div class="register-card-body">
							<div class="row mt-30">
								...
								<div class="col-lg-6">
									...
									<select class="form-control" id="business_type" name="business_type" onchange="hidecatercolumns()">
								...
								<div class="col-lg-12 bottom-btn">
									<div>
										<a href="{{ route('restaurant.register') }}?step=1"><button type="button" class="btn btn-danger">{{ __('Back') }}</button></a>
