												...
												<table class="table">
													...
													<tbody>
														...
														<tr>
															...
															<?php 
															  $dueAmount = 0;
																$dueAmount = (env('DEPOSIT_PERCENT') / 100) * $order->total;
																
																$balanceAmount = $order->total - $dueAmount;

															?>
																<td>{{ strtoupper($currency->value) }} {{ $balanceAmount }}</td>
															<td>{{ strtoupper($currency->value) }} {{ $order->total + $order->shipping }}</td>
																<td>{{ strtoupper($currency->value) }} {{ $dueAmount }}</td>
															<td>
