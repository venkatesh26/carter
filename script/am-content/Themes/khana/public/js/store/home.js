 $(function () {
    ...
    function LocationInput() {
     ...
     var to_places1 = new google.maps.places.Autocomplete(document.getElementById('b_address'));
     var place = to_places1.getPlace();

     google.maps.event.addListener(to_places1, 'place_changed', function () {

        var to_places1 = to_places1.getPlace(); 
        var to_address = to_places1.formatted_address;
        $('#location_input').val(to_address);
        // $('#district').val(to_places.getPlace().address_components[2]['long_name'])
        // localStorage.setItem('location',to_address);
        // localStorage.setItem('district',to_places.getPlace().address_components[2]['long_name']);
