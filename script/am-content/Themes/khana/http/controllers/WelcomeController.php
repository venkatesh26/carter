...
class WelcomeController extends controller
{
    ...
    public function index()
    {
       ...
       try {
          ...
          if(DB::connection()->getDatabaseName()){
            ...
            $stores = User::with('info','gallery','preview','avg_ratting','delivery','pickup','shopcategory','location','shopday','role','ratting','badge','usersaas')->where('status',"Approved")->where('paymentStatus',"1")->where('role_id', 3)->take(9)->get();
           ...
           $locations = array();
            ...
            return view('theme::welcome.home',compact('stores','top_rated','features_resturent','locations','offer_resturents','theme_color'));
          }else{
    ...
    public function signup(Request $request)
    {
        ...
        return view('theme::welcome.signup',compact('plan'));
    }
