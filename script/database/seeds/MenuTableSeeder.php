...
class MenuTableSeeder extends Seeder
{
    ...
    {	
        ...
        Menu::create([
            ...
            "data"=> '[{"text":"হোম","href":"/","icon":"","target":"_self","title":""},{"text":"আপানার শহর","href":"#","icon":"fas fa-angle-down","target":"_self","title":"","children":[{"text":"ঢাকা","href":"/area/dhaka","icon":"empty","target":"_self","title":""},{"text":"চট্রগ্রাম","href":"/area/chittagong","icon":"empty","target":"_self","title":""},{"text":" ফেণী","href":"/area/feni","icon":"empty","target":"_self","title":""},{"text":"বগুড়া","href":"/area/bogra","icon":"empty","target":"_self","title":""},{"text":"বরিশাল","href":"/area/barisal","icon":"empty","target":"_self","title":""},{"text":"রাজশাহী","href":"/area/rajshahi","icon":"empty","target":"_self","title":""},{"text":"খুলনা","href":"/area/khulna","icon":"empty","target":"_self","title":""},{"text":"রংপুর","href":"/area/rangpur","icon":"empty","target":"_self","title":""}]},{"text":"ক্রেতা","icon":"fas fa-angle-down","href":"#","target":"_self","title":"","children":[{"text":"লগইন","icon":"empty","href":"/user/login","target":"_self","title":""},{"text":"রেজিস্টার","icon":"empty","href":"/user/register","target":"_self","title":""},{"text":"ড্যাশবোর্ড","icon":"empty","href":"/author/dashboard","target":"_self","title":""}]},{"text":"রেস্তোরাঁ","icon":"fas fa-angle-down","href":"#","target":"_self","title":"","children":[{"text":"লগইন","icon":"empty","href":"/login","target":"_self","title":""},{"text":"রেজিস্টার","icon":"empty","href":"/restaurant/register","target":"_self","title":""},{"text":"ড্যাশবোর্ড","icon":"empty","href":"/store/dashboard","target":"_self","title":""}]}]',
            "lang"=>"bn",
            "status"=>1,
        ]);
        ...
        Menu::create([
            "name"=>"Quick Links",
            "position"=>"Footer First",
            "data"=> '[{"text":"About Us","icon":"","href":"#","target":"_self","title":""},{"text":"Add Your Restaturents","icon":"empty","href":"/user/register","target":"_self","title":""},{"text":"Help","icon":"empty","href":"#","target":"_self","title":""},{"text":"My Account","icon":"empty","href":"/author/dashboard","target":"_self","title":""}]',
            "lang"=>"en",
            "status"=>1,
        ]);
        ...
        Menu::create([
            "name"=>"Categories",
            "position"=>"Footer Second",
            "data"=> '[{"text":"Top Categories","icon":"","href":"#","target":"_self","title":""},{"text":"Best Rated","icon":"empty","href":"#","target":"_self","title":""},{"text":"Best Price","icon":"empty","href":"#","target":"_self","title":""},{"text":"Latest Submissions","icon":"empty","href":"#","target":"_self","title":""}]',
            "lang"=>"en",
            "status"=>1,
        ]);
